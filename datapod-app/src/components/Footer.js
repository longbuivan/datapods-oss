...
const Footer = () => {
  return (
      ...
      <div class="container mx-auto px-4 pt-20">
        <div class="Youtube ">
        <h1 class="text-3xl fonat-semibold text-base decoration	underline-offset-1 italic">P/S:</h1>
        <h2 class="text-3xl fonat-semibold text-base decoration	underline-offset-1 italic">If you want to check how I improve Productivity, check it out</h2>
        <a href="https://youtu.be/2nKRHoWemDQ">
                  ...
                  <div class="mt-3 text-base text-cyan-800">Youtube: How to Setup your machine as Data Engineer</div>
                  <div class="opacity-70">Stack: Homebrew, iTerm2, Custom terminal,Containers, Others...</div>
          </a>
        </div>
        <br/>
        <div>
            <h2 class="text-3xl fonat-semibold text-base decoration	underline-offset-1 italic">Created with:</h2>
            <ul class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <li class="text-center mb-4">
                <a href="https://tailwindcss.com/">
                  ...
                  <div class="mt-3 text-base">Tailwind</div>
              ...
              <li class="text-center mb-4">
                <a href="https://react.dev/">
                  ...
                  <div class="mt-3 text-base">ReactJs</div>
